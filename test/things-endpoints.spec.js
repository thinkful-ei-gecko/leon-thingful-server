  ...
  describe(`Protected endpoints`,() => {
    ...
    endpoints.forEach(endpoint => {
      describe(endpoint.name, () => {
        ...
        it (`Responds with a 401 when username is incorrect`, () => {
          const userNameIncorrect = { user_name: 'notRealUser', password: 'XXX'};
          return supertest(app)
            .get(endpoint.path)
            .set('Authorization', helpers.makeAuthHeader(userNameIncorrect))
            .expect(401, { error: `Unauthorized request`});
        });
